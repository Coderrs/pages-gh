  ...
  <div class="col-md-6">
    <div class="card flex-md-row mb-4 shadow-sm h-md-250">
      <div class="card-body d-flex flex-column align-items-start">
        <h3 class="mb-0">
          <strong class="d-inline-block mb-2">{{ post.data.title | truncate: 25 }}</strong>
      ...
      <img class="card-img-right flex-auto d-none d-lg-block" src="{{ post.data.profileimage }}" data-holder-rendered="true" style="width: 160px; height: 160px;border-radius: 80%;" alt="Avatar">
